...
public class ProjectController {
	...
	public String showRejectDetail(Model model, @PathVariable("project_seq") int project_seq, HttpSession session) {
		// 세션 레벨 가져오기
	...
	public String ShowProjectCommunity(@PathVariable("project_seq") int project_seq, Model model, HttpSession session) {
...
//			itemService.createItem(itemdto, session);	
	...
	public String saveItemCount(@RequestBody ItemListDTO itemListDTO, HttpSession session) {
	  ...
	  public String tabProjectPlan( Model model, HttpSession session) { 
		 // System.out.println(project_seq);//
	  ProjectDTO projectPlan = projectService.loadProjectPlan(session);
