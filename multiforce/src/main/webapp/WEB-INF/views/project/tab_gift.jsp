...
*/
	...
	$("#create_option_btn").on("click", function(){
		...
		//itemArr[nowItemArrIdx].optionDTOList.push(option);//itemArr의 [현재 선택된 ]
...
<div class="added_item_wrap_form">
	...
	아이템 개수: <input type="number" class="item_count_input">
</div>
<!--  -->
